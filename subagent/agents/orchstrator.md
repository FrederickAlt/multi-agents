...
3. You should delegate each of the unblocked issues in parallel to a coder subagent. For this you create a work-tree for each of them. Place the work-tree alongside the cwd you are in inside ../worktrees . Make sure to spawn the agent simultaneously and in parallel for these issues.
